// auth/rules.js - Aturan akses (permissions)
const RULES = {
  lowongan: { read: ['pemilik','admin','user'], write: ['pemilik','admin'], delete: ['pemilik','admin'] },
  pendingIklan: { read: ['pemilik','admin'], create: ['pemilik','admin','user'], update: ['pemilik','admin'], delete: ['pemilik','admin'] },
  users: { read: ['pemilik','admin'], write: ['pemilik','admin'], delete: ['pemilik','admin'] },
  lamaran: { readSelf: ['pemilik','admin','user'], readAll: ['pemilik','admin'], create: ['pemilik','admin','user'] },
  logs: { read: ['pemilik'] },
  kategori: { read: ['pemilik','admin','user'], write: ['pemilik'] },
  notifikasi: { read: ['pemilik','admin','user'], write: ['pemilik'] },
  backup: { read: ['pemilik'], write: ['pemilik'] },
